  ...
  public class SignedPacketWrapper extends SMB2Packet {
    ...
    private class SigningBuffer extends SMBBuffer {
      ...
      SigningBuffer(SMBBuffer wrappedBuffer) throws SecurityException {
        ...
        this.mac = PacketSignatory.getMac((PacketSignatory.SignedPacketWrapper.access$1(PacketSignatory.SignedPacketWrapper.this)).secretKey, (PacketSignatory.SignedPacketWrapper.access$1(PacketSignatory.SignedPacketWrapper.this)).algorithm, (PacketSignatory.SignedPacketWrapper.access$1(PacketSignatory.SignedPacketWrapper.this)).securityProvider);
      }
