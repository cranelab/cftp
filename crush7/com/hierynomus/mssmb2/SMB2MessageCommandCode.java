...
public enum SMB2MessageCommandCode {
  ...
  static {
    ...
    byte b;
    int i;
    SMB2MessageCommandCode[] arrayOfSMB2MessageCommandCode;
    for (i = (arrayOfSMB2MessageCommandCode = values()).length, b = 0; b < i; ) {
      SMB2MessageCommandCode smb2MessageCommandCode = arrayOfSMB2MessageCommandCode[b];
