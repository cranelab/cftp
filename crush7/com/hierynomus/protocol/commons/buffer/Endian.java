...
public abstract class Endian {
  private static final byte[] NULL_TERMINATOR = new byte[2];
  
  public static final Endian LE = new Little(null);
  
  public static final Endian BE = new Big(null);
  ...
  private static class Big extends Endian {
    ...
    public <T extends Buffer<T>> void writeUInt32(Buffer<T> buffer, long uint32) {
      ...
      buffer.putRawBytes(new byte[] { (byte)(int)(uint32 >> 24L), 
            (byte)(int)(uint32 >> 16L), 
            (byte)(int)(uint32 >> 8L), 
            (byte)(int)uint32 });
    }
    ...
    public <T extends Buffer<T>> void writeLong(Buffer<T> buffer, long longVal) {
      buffer.putRawBytes(new byte[] { (byte)(int)(longVal >> 56L), 
            (byte)(int)(longVal >> 48L), 
            (byte)(int)(longVal >> 40L), 
            (byte)(int)(longVal >> 32L), 
            (byte)(int)(longVal >> 24L), 
            (byte)(int)(longVal >> 16L), 
            (byte)(int)(longVal >> 8L), 
            (byte)(int)longVal });
    }
  ...
  private static class Little extends Endian {
    ...
    public <T extends Buffer<T>> void writeUInt16(Buffer<T> buffer, int uint16) {
      if (uint16 < 0 || uint16 > 65535)
        throw new IllegalArgumentException("Invalid uint16 value: " + uint16); 
      buffer.putRawBytes(new byte[] { (byte)uint16, 
            (byte)(uint16 >> 8) });
    }
    ...
    public <T extends Buffer<T>> void writeUInt24(Buffer<T> buffer, int uint24) {
      if (uint24 < 0 || uint24 > 16777215)
        throw new IllegalArgumentException("Invalid uint24 value: " + uint24); 
      buffer.putRawBytes(new byte[] { (byte)uint24, 
            (byte)(uint24 >> 8), 
            (byte)(uint24 >> 16) });
    }
    ...
    public <T extends Buffer<T>> void writeUInt32(Buffer<T> buffer, long uint32) {
      if (uint32 < 0L || uint32 > 4294967295L)
        throw new IllegalArgumentException("Invalid uint32 value: " + uint32); 
      buffer.putRawBytes(new byte[] { (byte)(int)uint32, 
            (byte)(int)(uint32 >> 8L), 
            (byte)(int)(uint32 >> 16L), 
            (byte)(int)(uint32 >> 24L) });
    }
    ...
    public <T extends Buffer<T>> void writeLong(Buffer<T> buffer, long longVal) {
      buffer.putRawBytes(new byte[] { (byte)(int)longVal, 
            (byte)(int)(longVal >> 8L), 
            (byte)(int)(longVal >> 16L), 
            (byte)(int)(longVal >> 24L), 
            (byte)(int)(longVal >> 32L), 
