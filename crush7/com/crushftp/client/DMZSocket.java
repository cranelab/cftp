...
public class DMZSocket extends Socket {
  ...
  public static Socket getDmzHostPortSock(String dmz_item) throws IOException {
    ...
    Socket sock = factory.createSocket(name_host_port.split(":")[1], Integer.parseInt(name_host_port.split(":")[2]));
    Common.sockLog(sock, "Got DMZHostPortSock:" + dmz_item + ":" + name_host_port);
    return sock;
  }
