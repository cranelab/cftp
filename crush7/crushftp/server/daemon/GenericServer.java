        ...
        try {
          if (this.server_item.getProperty("serverType", "false").toUpperCase().equals("FTPS") || this.server_item.getProperty("serverType", "FTP").toUpperCase().equals("HTTPS") || this.server_item.getProperty("serverType", "FTP").toUpperCase().equals("PORTFORWARDS")) {
            ...
            if (this.sni_enabled) {
              ...
              if (this.listen_ip.equals("lookup")) {
                this.server_sock = ServerStatus.thisObj.common_code.getServerSocket(this.listen_port, null, this.keystore, this.keystorePass, this.certPass, ServerStatus.SG("disabled_ciphers"), this.needClientAuth, 1000, true, false);
              } else {
                this.server_sock = ServerStatus.thisObj.common_code.getServerSocket(this.listen_port, this.listen_ip, this.keystore, this.keystorePass, this.certPass, ServerStatus.SG("disabled_ciphers"), this.needClientAuth, 1000, true, false);
              } 
