      ...
      while (this.socket_created && this.die_now.length() == 0) {
        ...
        Runnable sr = new Runnable(this) {
            ...
            public void run() {
              ...
              (new QuickConnect(this.this$0.thisObj, this.this$0.listen_port, sock2, this.this$0.the_ip, String.valueOf(this.this$0.listen_ip) + "_" + this.this$0.listen_port, this.this$0.server_item)).run();
            }
          };
        try {
    ...
    try {
      ...
      for (int x = 0; x < names.size(); x++) {
        ...
        if (type.equals("0")) {
          ...
          f = new File(String.valueOf(f.getParentFile().getAbsolutePath()) + "/" + host + "_" + f.getName());
          if (f.exists()) {
            keystore2 = f.getPath();
