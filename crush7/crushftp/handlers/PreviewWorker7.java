...
public class PreviewWorker7 implements Serializable {
  ...
  public PreviewWorker7(Properties prefs) {
    this.prefs = prefs;
    try {
  ...
  class discarder implements Runnable {
    ...
    final PreviewWorker7 this$0;
    
    public discarder(PreviewWorker7 this$0, InputStream in) {
      this.this$0 = this$0;
      this.in = null;
      this.in = in;
    }
