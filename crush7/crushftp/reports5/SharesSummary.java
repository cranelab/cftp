...
public class SharesSummary {
  ...
  public void generate(Properties stats, Properties params, StringBuffer sb, Properties status) {
    try {
      ...
      Vector shares = ServerStatus.thisObj.statTools.executeSqlQuery(share_sql, new Object[] { "SHARE", mmddyyyy.parse(params.getProperty("startDate", "1/1/2000")), mmddyyyy.parse(params.getProperty("endDate", "1/1/2100")) }false);
