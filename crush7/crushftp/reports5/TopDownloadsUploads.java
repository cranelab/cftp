...
public class TopDownloadsUploads {
  ...
  public void generate(Properties stats, Properties params, StringBuffer sb, Properties status) {
    try {
      ...
      Vector uploads = null;
      if (ServerStatus.thisObj.statTools.mssql) {
        downloads = ServerStatus.thisObj.statTools.executeSqlQuery(download_sql, new Object[] { "DOWNLOAD", mmddyyyy.parse(params.getProperty("startDate", "1/1/2000")), mmddyyyy.parse(params.getProperty("endDate", "1/1/2100")) }false);
        uploads = ServerStatus.thisObj.statTools.executeSqlQuery(upload_sql, new Object[] { "UPLOAD", mmddyyyy.parse(params.getProperty("startDate", "1/1/2000")), mmddyyyy.parse(params.getProperty("endDate", "1/1/2100")) }false);
      } else {
        downloads = ServerStatus.thisObj.statTools.executeSqlQuery(download_sql, new Object[] { "DOWNLOAD", mmddyyyy.parse(params.getProperty("startDate", "1/1/2000")), mmddyyyy.parse(params.getProperty("endDate", "1/1/2100")), Integer.valueOf(params.getProperty("downloadCount")) }false);
        uploads = ServerStatus.thisObj.statTools.executeSqlQuery(upload_sql, new Object[] { "UPLOAD", mmddyyyy.parse(params.getProperty("startDate", "1/1/2000")), mmddyyyy.parse(params.getProperty("endDate", "1/1/2100")), Integer.valueOf(params.getProperty("uploadCount")) }false);
      } 
      try {
