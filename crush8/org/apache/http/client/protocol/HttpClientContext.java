...
public class HttpClientContext extends HttpCoreContext {
  ...
  public RouteInfo getHttpRoute() {
    return getAttribute("http.route", (Class)HttpRoute.class);
  }
  
  public List<URI> getRedirectLocations() {
    return getAttribute("http.protocol.redirect-locations", (Class)List.class);
  }
  
  public CookieStore getCookieStore() {
    return getAttribute("http.cookie-store", CookieStore.class);
  }
  ...
  public CookieSpec getCookieSpec() {
    return getAttribute("http.cookie-spec", CookieSpec.class);
  }
  
  public CookieOrigin getCookieOrigin() {
    return getAttribute("http.cookie-origin", CookieOrigin.class);
  }
  
  private <T> Lookup<T> getLookup(String name, Class<T> clazz) {
    return getAttribute(name, (Class)Lookup.class);
  }
  ...
  public CredentialsProvider getCredentialsProvider() {
    return getAttribute("http.auth.credentials-provider", CredentialsProvider.class);
  }
  ...
  public AuthCache getAuthCache() {
    return getAttribute("http.auth.auth-cache", AuthCache.class);
  }
  ...
  public AuthState getTargetAuthState() {
    return getAttribute("http.auth.target-scope", AuthState.class);
  }
  
  public AuthState getProxyAuthState() {
    return getAttribute("http.auth.proxy-scope", AuthState.class);
  }
  ...
  public RequestConfig getRequestConfig() {
    RequestConfig config = getAttribute("http.request-config", RequestConfig.class);
