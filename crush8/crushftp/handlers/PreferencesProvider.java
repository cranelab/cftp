      ...
      try {
        ...
        try {
          if (!(new File_S(String.valueOf(System.getProperty("crushftp.prefs")) + "prefs" + instance + ".XML")).exists()) {
            ...
            makeIt.close();
            ServerStatus.thisObj.server_info.put("currentFileDate" + instance, (new StringBuffer(String.valueOf((new File_S(String.valueOf(System.getProperty("crushftp.prefs")) + "prefs" + instance + ".XML")).lastModified()))).toString());
          } 
