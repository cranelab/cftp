...
public class LoggingProvider {
  ...
  public String newTags = "(SERVER),(UPDATE),(PREVIEW),(SMTP),(USER),(SEARCH),(STAT),(REPORT),(SSH_SERVER),(HTTP_SERVER),(DAV_SERVER),(FTP_SERVER),(AS2_SERVER),(EVENT),(LIST),(DOWNLOAD),(UPLOAD),(VFS),(SERVERBEAT),(ACCESS),(QUOTA),(PLUGIN),(AUTH),(BAN),(SYNC),(ALERT),(GENERAL),(FILE_CLIENT),(FTP_CLIENT),(S3_CLIENT),(SSH_CLIENT),(TUNNEL),(DMZ),(JOB_SCHEDULER)";
