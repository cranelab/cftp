...
public class DMZQueueSocket_CheckedInputStream extends Socket {
  Socket sock = null;
  ...
  public synchronized void close2(boolean write_0) throws IOException {
    System.out.println(String.valueOf(System.currentTimeMillis()) + ":" + Character.MIN_VALUE + ":SOCK_CLOSE_START:" + write_0);
    try {
      if (write_0)
    ...
    System.out.println(String.valueOf(System.currentTimeMillis()) + ":" + Character.MIN_VALUE + ":SOCK_CLOSE_END:" + write_0);
  }
  ...
  public InputStream getInputStream() throws IOException {
    if (this.in2 == null)
      this.in2 = new DMZQueueSocket_CheckedInputStream$1$CheckedInputStream(this, this.sock.getInputStream()); 
    return this.in2;
  }
  
  public OutputStream getOutputStream() throws IOException {
    if (this.out2 == null)
      this.out2 = new DMZQueueSocket_CheckedInputStream$1$CheckedOutputStream(this, this.sock.getOutputStream()); 
    return this.out2;
  }
