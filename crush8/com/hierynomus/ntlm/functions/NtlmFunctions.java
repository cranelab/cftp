...
public class NtlmFunctions {
  ...
  private static byte[] setupKey(byte[] key56) {
    ...
    key[1] = (byte)(((key56[0] & 0x1) << 6 | (key56[1] & 0xFF) >> 2 & 0xFF) & 0xFF);
    key[2] = (byte)(((key56[1] & 0x3) << 5 | (key56[2] & 0xFF) >> 3 & 0xFF) & 0xFF);
    key[3] = (byte)(((key56[2] & 0x7) << 4 | (key56[3] & 0xFF) >> 4 & 0xFF) & 0xFF);
    key[4] = (byte)(((key56[3] & 0xF) << 3 | (key56[4] & 0xFF) >> 5 & 0xFF) & 0xFF);
