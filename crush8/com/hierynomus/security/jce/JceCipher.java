...
public class JceCipher implements Cipher {
  ...
  JceCipher(String name, Provider jceProvider, String providerName) throws SecurityException {
    ...
    } catch (NoSuchAlgorithmException|javax.crypto.NoSuchPaddingException|java.security.NoSuchProviderException e) {
  ...
  public int doFinal(byte[] out, int outOff) throws SecurityException {
    ...
    } catch (BadPaddingException|javax.crypto.IllegalBlockSizeException|ShortBufferException e) {
      throw new SecurityException(e);
    } 
  }
