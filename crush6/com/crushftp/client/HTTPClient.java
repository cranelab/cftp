...
public class HTTPClient extends GenericClient {
  ...
  public String login2(String username, String password, String clientid) throws Exception {
    ...
    this.config.put("crushAuth", cookie.substring(cookie.indexOf("CrushAuth=") + "CrushAuth=".length(), cookie.indexOf(";", cookie.indexOf("CrushAuth="))));
  ...
  protected InputStream download3(String path, long startPos, long endPos, boolean binary) throws Exception {
    return download3(path, startPos, endPos, binary, (String)null);
  }
  
  protected InputStream download3(String path, long startPos, long endPos, boolean binary, String paths) throws Exception {
    log("download | " + path + " | " + startPos + " | " + endPos + " | " + binary + ((paths != null) ? (" | downloadAsZip:" + paths) : ""));
  ...
  public InputStream downloadAsZip(String path, String paths, boolean path_shortening) throws Exception {
    ...
    return download3(path, 0L, -1L, true, paths);
  }
