  ...
  public String doCommand(String command) throws Exception {
    ...
    if (command.toUpperCase().startsWith("SITE PROXY_CONFIRM")) {
      ...
      if (this.as2Info.containsKey("mdnInfo")) {
        ...
        log("Current pending AS2 OIDs:" + System.getProperties().get("crushftp.as2_async_mdn"));
        if (mdnInfo.getProperty("async", "").equals("true") && !mdnInfo.containsKey("received-content-mic") && System.getProperties().containsKey("crushftp.as2_async_mdn"))
          if (((Properties)System.getProperties().get("crushftp.as2_async_mdn")).containsKey(mdnInfo.getProperty("oid", "")))
            mdnInfo.putAll((Properties)((Properties)System.getProperties().get("crushftp.as2_async_mdn")).remove(mdnInfo.getProperty("oid", "")));  
