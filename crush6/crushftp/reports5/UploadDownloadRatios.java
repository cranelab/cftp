...
public class UploadDownloadRatios {
  ...
  public void generate(Properties stats, Properties params, StringBuffer sb, Properties status) {
    try {
      ...
      Vector ratios = ServerStatus.thisObj.statTools.executeSqlQuery(sql, new Object[] { mmddyyyy.parse(params.getProperty("startDate", "1/1/2000")), mmddyyyy.parse(params.getProperty("endDate", "1/1/2100")) }false);
      ...
      if (ratios.size() > 0)
        sb.append(common_code.getXMLString(results, "results", "WebInterface/Reports/UploadDownloadRatios.xsl")); 
    } catch (Exception e) {
      Log.log("REPORT", 1, e);
    } 
  }
