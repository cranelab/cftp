...
public class WhoDownloadedFile {
  ...
  class sorter implements Comparator {
    ...
    final WhoDownloadedFile this$0;
    
    sorter(WhoDownloadedFile this$0) {
      this.this$0 = this$0;
      this.allItems = null;
      this.sort = null;
    }
  ...
  public void generate(Properties stats, Properties params, StringBuffer sb, Properties status) {
    try {
      ...
      Vector users = ServerStatus.thisObj.statTools.executeSqlQuery(sql, new Object[] { mmddyyyy.parse(params.getProperty("startDate", "1/1/2000")), mmddyyyy.parse(params.getProperty("endDate", "1/1/2100")) }false);
      ...
      if (method.equals("equals"))
        path = path; 
      Vector allFiles = ServerStatus.thisObj.statTools.executeSqlQuery(sql_files, new Object[] { mmddyyyy.parse(params.getProperty("startDate", "1/1/2000")), mmddyyyy.parse(params.getProperty("endDate", "1/1/2100")), path, filename }false);
      ...
      if (users.size() > 0)
        sb.append(common_code.getXMLString(results, "results", "WebInterface/Reports/WhoDownloadedFile.xsl")); 
    } catch (Exception e) {
      Log.log("REPORT", 1, e);
    } 
  }
